...
export default function CreateJobPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const jobData = {
      ...
      // ✅ --- ส่วนที่แก้ไข --- ✅
      // เปลี่ยนจากการ Hardcode 'admin' มาใช้ค่าจาก State 'leadTechnician'
      creatorId: leadTechnician,
      // --- สิ้นสุดการแก้ไข ---
    };
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
        <form id="create-job-form" className="md:col-span-3 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <Textarea id="jobDescription" name="jobDescription" placeholder="Enter job description" className="mt-2 resize-none h-26overflow-y-auto" />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <Label htmlFor="leadTechnician">Lead technician / Created By</Label>
