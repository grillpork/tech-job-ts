...
export default function HistoryPage() {
  ...
  const filteredLogs = useMemo(() => {
    // ถ้าไม่มี currentUser ให้ return array ว่าง
  ...
  }, [auditLogs, filterAction, filterEntity, currentUser]);
    ...
    return (
      <div className="p-4 md:p-8 text-zinc-900 dark:text-white bg-gray-50 dark:bg-zinc-900 min-h-full">
        <div className="text-center py-12">
          <AlertCircle className="w-16 h-16 mx-auto text-gray-400 dark:text-zinc-600 mb-4" />
          <p className="text-lg text-gray-500 dark:text-zinc-400">
            กรุณาล็อกอินเพื่อดูประวัติการทำงาน
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="p-4 md:p-8min-h-full">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold">ประวัติการกระทำของฉัน</h1>
          <p className="text-sm text-gray-500 dark:text-zinc-400 mt-1">
            แสดงเฉพาะการกระทำที่คุณดำเนินการในระบบ
          </p>
        </div>
