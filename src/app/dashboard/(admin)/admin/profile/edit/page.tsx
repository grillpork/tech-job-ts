...
const EditProfilePage: React.FC = () => {
  ...
  const handleSave = async () => {
    const updatedData: any = {
      ...
      // role, department, employmentType, accountTier are read-only and not included
        ...
        <section className="bg-white dark:bg-[#2a2a2a] border border-gray-200 dark:border-gray-800 rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
              ...
              <Input value={form.role} readOnly className="mt-1 text-gray-200 cursor-not-allowed" disabled />

              <Label className="mt-4">Department</Label>
              <Input value={form.department} readOnly className="mt-1 text-gray-200 cursor-not-allowed" disabled />
            ...
            <div>
              ...
              <Input value={form.employmentType} readOnly className="mt-1 text-gray-200 cursor-not-allowed" disabled />
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Input value={form.accountTier} readOnly className="mt-1  text-gray-200 cursor-not-allowed" disabled />
            </div>
          </div>
        </section>
      </div>
