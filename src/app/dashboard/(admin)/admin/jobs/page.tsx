...
const JobsList = () => {
  ...
  const getStatusColor = (status: string) => {
    ...
    switch (s) {
      ...
      case "pending_approval":
        return "bg-yellow-500/20 text-black text-shadow-mg border-yellow-500/30 dark:bg-yellow-500/20 dark:text-yellow-400 dark:border-yellow-500/30";
      case "in_progress":
        return "bg-blue-500/20 text-black text-shadow-mg border-blue-500/30 dark:bg-blue-500/20 dark:text-blue-400 dark:border-blue-500/30";
      case "completed":
        return "bg-green-500/20 text-black text-shadow-mg border-green-500/30 dark:bg-green-500/20 dark:text-green-400 dark:border-green-500/30";
      case "cancelled":
      case "rejected":
        return "bg-red-500/20 text-black text-shadow-mg border-red-500/30 dark:bg-red-500/20 dark:text-red-400 dark:border-red-500/30";
      default:
        return "bg-gray-500/20 text-black text-shadow-mg border-gray-500/30 dark:bg-gray-500/20 dark:text-gray-400 dark:border-gray-500/30";
    }
  };
  ...
  const getPriorityColor = (priority: string | null | undefined) => {
    ...
    switch (priority.toLowerCase()) {
      case "urgent":
        return "bg-red-500/20 text-shadow-mg text-black border-red-500/30";
      case "high":
        return "bg-orange-500/20  text-shadow-mg text-black border-orange-500/30";
      case "medium":
        return "bg-yellow-500/20 text-shadow-mg text-black border-yellow-500/30";
      case "low":
        return "bg-blue-500/20 text-shadow-mg text-black border-blue-500/30";
      default:
        return "bg-gray-500/20 text-black text-shadow-mg border-gray-500/30";
    }
  };
